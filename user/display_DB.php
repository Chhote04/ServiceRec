...
<head>
	...
	<title>SR - Service History</title>
		...
		<div class="row">
			...
			<table class="table">
				...
				<tbody>
					...
					$data = "SELECT * FROM servicedetails where user_id='$user_id'";
      ...
      //            		print_r($d);
					...
					<tr>
					    ...
					    <td>
                 		...
                 		<a href="view_DB.php?id=<?php echo $d['id']?>" class="btn btn-primary"  style="font-size: 10px ; ">View</a>
